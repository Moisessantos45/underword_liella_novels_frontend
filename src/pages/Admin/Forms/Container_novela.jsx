        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2 w-11/12 mx-auto">
            ...
            <input
              type="text"
              className="border rounded h-10 w-full focus:outline-none text-slate-400 focus:text-slate-700 focus:border-green-200 px-2 text-sm"
              placeholder="URL del background"
              value={backgroud}
            ...
            <input
              type="text"
              className="border rounded h-10 w-full focus:outline-none text-slate-400 focus:text-slate-700 focus:border-green-200 px-2 text-sm"
              placeholder="Géneros de la novela"
              value={generos}
          ...
          <div className="mx-auto w-11/12">
            <input
              type="text"
              className="border rounded h-32 w-full focus:outline-none text-slate-400 focus:text-slate-700 focus:border-green-200 px-2 text-sm scrollbar"
